...
Public Class StaffInWardForm
    Public sqlConn = "Data Source=LAPTOP-2EPJEP2A\MYSQL;Initial Catalog=Wellmeadows;Integrated Security=True"
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        ...
        If Ward_StaffsTable.CurrentRow IsNot Nothing Then
            ...
            Edit_StaffInWardForm.lastname.Text = wardStaffsData("shiftID")
    ...
    Private Sub StaffInWardForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Using connection As New SqlConnection("Data Source=LAPTOP-2EPJEP2A\MYSQL;Initial Catalog=Wellmeadows;Integrated Security=True") ' แทนที่ Your_Connection_String ด้วยข้อมูลการเชื่อมต่อฐานข้อมูลของคุณ
            connection.Open()
        ...
        'connection string
        Using connection As New SqlConnection("Data Source=LAPTOP-2EPJEP2A\MYSQL;Initial Catalog=Wellmeadows;Integrated Security=True")
            connection.Open()
            Try
                Dim sql As String = "SELECT wardname FROM Wards ORDER BY ID;"
                ...
                While reader.Read()
                    cbbWardId.Items.Add(reader("wardname").ToString())
                End While
