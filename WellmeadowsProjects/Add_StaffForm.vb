Public Class Add_StaffForm
    ...
    Private Sub AddInputItem()
        ...
        textBox1.Location = New Point(typelb.Location.X, typelb.Location.Y + count)
        panel.Controls.Add(textBox1)
        inputControls.Add(textBox1)

        Dim textBox2 As New TextBox()
        textBox2.Scale(New SizeF(1.5F, 1.5F))
        textBox2.Location = New Point(majorlb.Location.X, typelb.Location.Y + count)
        ...
        dateTimePicker.Location = New Point(finishdatelb.Location.X, typelb.Location.Y + count)
    ...
    Private Sub AddInputItem2()
        ...
        positionbox.Location = New Point(hispositionlb.Location.X, hispositionlb.Location.Y + count2)
        ...
        companybox.Location = New Point(hiscompanylb.Location.X, hiscompanylb.Location.Y + count2)
        panel.Controls.Add(companybox)
        inputControlsExp.Add(companybox)


        Dim startdate As New DateTimePicker()
        startdate.Location = New Point(hisstartdatelb.Location.X, hiscompanylb.Location.Y + count2)
        ...
        enddate.Location = New Point(hisenddatelb.Location.X, hiscompanylb.Location.Y + count2)
    ...
    Private Sub hisenddatelb_Click(sender As Object, e As EventArgs) Handles hisenddatelb.Click
