...
9.1 เลือกว่าแอปพลิเคชันจะดึงข้อมูลมาจากที่ไหน โดยเราจะดึงข้อมูลมาจาก Database จากนั้นกด Next จากนั้นเลือก Dataset และ กด Next ดังภาพด้านล่างนี้: 
...
ต้องการอีกรอบ และให้กดเลือก `show the connection string that you will have save on the application` ในกรณีที่โปรแกรมไม่ได้เลือกให้แต่แรก
จากนั้นให้ copy connection string ที่โชว์ขึ้นมาเก็บไว้เพื่อใช้ในโปรแกรม
...
12. จากนั้นไปที่แท็ป Solution Explorer แล้วหาไฟล์ชื่อ `sqlConnString.vb` และเปิดขึ้นมา

 ![image](./image/8.png)
 
13. จากนั้นวาง sql connection string ที่ copy ไว้ตอนเพิ่ม data source ไว้ข้างใน double quote ของตัวแปร `sqlConn` ดังรูปภาพ

![image](./image/9.png)
14. กดรันเพื่อใช้งานโปรแกรมได้เลย !
